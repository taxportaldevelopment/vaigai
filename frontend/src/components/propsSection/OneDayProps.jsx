...
import onedat8 from "../../assets/one-day/annaipatti-dam.jpg";
import onedat9 from "../../assets/one-day/madurai.jpg";
        ...
        <div className="container-fluid">
             <div className="row">
                  <div className="col-md-12 col-lg-4">
                        ...
                        <h6 className="text-uppercase py-3 fw-bold">Vaigai Dam</h6>
                  </div>
                  <div className="col-md-12 col-lg-4">
                  <div className="packge-tours-day">
                        ...
                        <h6 className="text-uppercase py-3">Athoor Dam</h6>
                  </div>
                  <div className="col-md-12 col-lg-4">
                  <div className="packge-tours-day">
                        ...
                        <h6 className="text-uppercase py-3">Southuparai dam</h6>
                  </div>
             ...
             <div className="row mt-2">
                  ...
                  <div className="packge-tours-day">
                        ...
                        <h6 className="text-uppercase py-3">dindigul palani tour</h6>
                  </div>
                  <div className="col-md-12 col-lg-4">
                  <div className="packge-tours-day">
                        ...
                        <h6 className="text-uppercase py-3">Kumbakarai falls</h6>
                  </div>
                  <div className="col-md-12 col-lg-4">
                  <div className="packge-tours-day">
                        ...
                        <h6 className="text-uppercase py-3">sirumali</h6>
                  </div>
             </div>     
             ...
             <div className="row mt-2">
                  ...
                  <div className="col-md-12 col-lg-4">
                     <div className="packge-tours-day">
                        ...
                        <h6 className="text-uppercase py-3">vattakanal water falls</h6>
                  </div>
                  <div className="col-md-12 col-lg-4">
                  <div className="packge-tours-day">
                  ...
                  <div className="col-md-12 col-lg-4">
                  <div className="packge-tours-day">
                           <img src={onedat21} className="w-100 p-1" alt="" />
                           <div className="package-whatsapp d-flex justify-content-center align-items-center w-100 h-100">
                                <div>
                                    <div className="h1 d-flex justify-content-center align-items-center">
                                       <a href="https://wa.me/8489946488?text=Hello%20there!" target="_blank" className="text-success"><FaWhatsapp /></a>   
                        ...
                        <h6 className="text-uppercase py-3">dindigul city tour</h6>
                  </div>
                  <div className="col-md-12 col-lg-4">
                  <div className="packge-tours-day">
